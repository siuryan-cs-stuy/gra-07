...
void draw_polygons( struct matrix *polygons, screen s, color c ) {
    ...
    for (point=0; point < polygons->lastcol-2; point+=3) {
        ...
        Az = polygons->m[2][point+1] - polygons->m[2][point];
        Bx = polygons->m[0][point+2] - polygons->m[0][point];
        By = polygons->m[1][point+2] - polygons->m[1][point];
        Bz = polygons->m[2][point+2] - polygons->m[2][point];
        Nx = Ay*Bz - Az*By;
        Ny = Az*Bx - Ax*Bz;
        Nz = Ax*By - Ay*Bx;
...
void add_box( struct matrix * edges,
  ...
  // bottom
  add_polygon(edges, x0, y1, z1, x0, y1, z0, x1, y1, z1);
  ...
  add_polygon(edges, x0, y1, z1, x0, y0, z1, x0, y1, z0);

  // back
  add_polygon(edges, x0, y0, z1, x1, y0, z1, x0, y1, z1);
  add_polygon(edges, x1, y1, z1, x1, y0, z1, x0, y1, z1);
  ...
  add_polygon(edges, x1, y1, z1, x1, y0, z1, x0, y1, z1);
  add_polygon(edges, x1, y1, z1, x1, y1, z0, x1, y0, z1);
  add_polygon(edges, x1, y1, z1, x0, y1, z1, x1, y1, z0);
  */
  }
